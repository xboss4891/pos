<?php
	...
	* */
	...
	class Sslcommerz
	{
	    ...
	    public function ValidateResponse($amount = 0, $currency = "BDT", $post_data = array())
	    {
	        ...
	        if ($merchant_trans_amount != 0) {
	            ...
	            if ($this->SSLCOMMERZ_hash_varify($this->store_pass, $post_data)) {
	                ...
	                if ($code == 200 && !(curl_errno($handle))) {
						...
						$data=array("widget_name"=>$result,"status"=>1);
						$CI->db->insert('tbl_widget', $data);*/
	    ...
	    protected function SSLCOMMERZ_hash_varify($store_passwd = "", $post_data = array())
	    {
