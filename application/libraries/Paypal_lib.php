...
class paypal_lib {
	...
	function button($value)
	{
		...
		$this->submit_btn = form_submit('custom', $value);
	}
	...
	function paypal_auto_form() 
	{
		...
		echo '<p style="text-align:center; font-size:28px; font-width:bold;">Please wait</p>' . "\n";
	...
	function paypal_form($form_name='paypal_form') 
	{
		...
		$str .= '<p style="display:none;">'. $this->submit_btn . '</p>';
		$str .= form_close() . "\n";
