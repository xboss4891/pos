                        ...
                        <td>
                            ...
                            <table border="0" class="wpr_100" style="width:100%">
                                ...
                                <tr>
                                    <td align="center">
                                        <nobr>
                                            <date>
                                                <?php echo display('token_no') ?>:<?php echo $orderinfo->tokenno ?? ''; ?>
                            ...
                            <table width="100%">
                                ...
                                foreach ($iteminfo as $item) {
                                    ...
                                    $discount    = 0;
                                    $adonsprice  = 0;
                                    $newitem     = $this->order_model->read('*', 'order_menu', ['row_id' => $item->row_id, 'isupdate' => 1]);
                                    $isexitsitem = $this->order_model->readupdate('tbl_updateitems.*,SUM(tbl_updateitems.qty) as totalqty', 'tbl_updateitems', ['ordid' => $item->order_id, 'menuid' => $item->menu_id, 'varientid' => $item->varientid, 'addonsuid' => $item->addonsuid]);
                                    ...
                                    if ($newitem->menu_id ?? '0' == $isexitsitem->menuid ?? '0' && $newitem->isupdate ?? '0' == 1) {

                                ?>
                                <tr>
                                    <td align="left"><?php echo $item->menuqty; ?></td>
                                    <td align="left"><?php echo $item->ProductName; ?><br><?php echo $item->notes; ?>
                                    </td>
                                ...
                                if (isset($exitsitem)) {
                                    ...
                                    foreach ($exitsitem as $exititem) {
                                        ...
                                        $isexitsitem = $this->order_model->readupdate('tbl_updateitems.*,SUM(tbl_updateitems.qty) as totalqty', 'tbl_updateitems', ['ordid' => $orderinfo->order_id, 'menuid' => $exititem->menu_id, 'varientid' => $exititem->varientid, 'addonsuid' => $exititem->addonsuid]);
                                ...
                                ?>
                                <tr>
                                    <td align="left"><?php echo $isexitsitem->isupdate; ?>
                                        <?php echo $isexitsitem->totalqty; ?></td>
                                    <td align="left">
                                        <?php echo $exititem->ProductName; ?><br><?php echo $exititem->notes; ?></td>
