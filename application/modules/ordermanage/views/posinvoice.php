...
foreach ($iteminfo as $item) {
    ...
    ?>
                        <div class="row-data">
                            <div class="item-info">
                                <h5 class="item-title m-0"><?php echo $item->ProductName; ?></h5>
                                <p class="item-size m-0"><?php echo $item->variantName; ?></p>
                                <p class="item-number m-0"><?php echo $singleprice; ?> x <?php echo $item->menuqty; ?>
                                </p>
                            </div>
                            <h5><?php
...
if (empty($billinfo)) {$discount;} else { $discount = $billinfo->discount;}
...
?> <?php echo $billinfo->total_amount; ?> <?php
...
if (empty($taxinfos)) {
    ...
    foreach ($taxinfos as $mvat) {
        ...
        if ($mvat['is_show'] == 1) {
            $taxinfo   = $this->order_model->read('*', 'tax_collection', ['relation_id' => $orderinfo->order_id]);
            $fieldname = 'tax' . $i;
...
if (empty($billinfo)) {echo $sdcharge;} else {echo $sdcharge = $billinfo->service_charge;}
...
if (empty($billinfo)) {echo $discount;} else {echo $discount = $billinfo->discount;}
...
?> <?php echo $billinfo->bill_amount; ?> <?php
            ...
            <div class="invoice_address">
                ...
                <div class="middle-data">
                    <div class="item-info gap_right">
                        <h5 class="item-title"><?php echo display('table'); ?>: <?php echo @$tableinfo->tablename; ?>
                        </h5>
                    </div>
                    <div class="item-info">
                        <h5 class="item-title"><?php echo display('orderno') ?>: <?php echo $orderinfo->order_id; ?>
                        </h5>
                    </div>
                </div>
                <div class="middle-data">
