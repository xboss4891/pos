                ...
                <div class="panel m-0">
                    <div class="panel-body pb-0">
                        ...
                        <table class="table table-fixed table-bordered table-hover bg-white wpr_100">
                            <thead>
                                <tr>
                                    <?php if ($duemerge == 0) { ?><th class="text-center"><?php echo display('sl'); ?>.
                                    </th><?php } ?>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php if ($duemerge == 1) { ?><input class="marg-check display-none"
                                            type="checkbox" value="<?php echo $order->order_id; ?>"
                                            onclick="margeorder()" name="order[]" checked>
                                        <?php } ?><?php echo $order->order_id; ?></td>
                            ...
                            <div class="row no-gutters">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group custom-select">
                                        ...
                                        <select name="discountttch" class="form-control custom-form-control"
                                            id="discountttch" onchange="changetype()">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="discount"
                                            class="col-form-label pb-2"><?php echo display('discount'); ?>(<span
                                                id="chty">
                                                <?php if ($settinginfo->discount_type == 0) {
                                        ...
                                        <input type="number" class="form-control custom-form-control" id="discount"
                                            name="discount" value="<?php echo $settinginfo->discountrate; ?>"
                                            placeholder="0" />
                                ...
                                <div class="">
                                    ...
                                    <div class="form-group">
                                        <label for="redempoint" class="col-form-label pb-2 plw-align">Points:
                                            <?php echo $customerpoints->points ?? 0; ?></label>
                                        <div class="kitchen-tab"><input id="chkbox-red" type="checkbox"
                                                class="individual" name="redeemit" value="<?php echo $customerid; ?>">
                            ...
                            <div id="adddiscount" class="display-none">
                                <div class="row no-gutters">
                                    <div class="form-group col-md-6">
                                        ...
                                        <?php $card_type = 4;
                                        echo form_dropdown('paytype[]', $paymentmethod, (!empty($card_type) ? $card_type : null), 'class="card_typesl postform resizeselect custom-form-control form-control " onchange="showhidecard(this)"') ?>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" id="paidamount_marge"
                                            class="form-control custom-form-control number pay firstpay"
                                            name="paidamount[]" value="<?php echo $totaldue - $disamount; ?>"
                                ...
                                <div class="row no-gutters">
                                    <div class="cardarea w-100 no-gutters display-none">
                                        <div class="form-group col-md-6">
                                            ...
                                            <?php echo form_dropdown('card_terminal[]', $terminalist, '', 'class="postform resizeselect form-control custom-form-control" ') ?>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <?php echo form_dropdown('bank[]', $banklist, '', 'class="postform resizeselect form-control custom-form-control" ') ?>
                                ...
                                <div class="form-group text-right">
                                    <div class="col-sm-12 pr-0">
                                        <button type="button" id="add_new_payment_type"
                                            class="btn btn-green w-md m-b-5"><?php echo display('add_new_payment_type'); ?></button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="payment-method-total">
                                <table
                                    class="table table-fixed table-bordered table-hover bg-white wpr_100 m-0 dfsgsfsfgsgfsfg">
                                    <tr>
                                        <td>
                                            <?php echo display('total_amount'); ?>
                                        </td>
                                        <td class="font-weight text-green" id="totalamount_marge">
                                    ...
                                    <tr>
                                        ...
                                        <td class="font-weight text-danger" id="due-amount">
                                            <?php echo $totaldue - $disamount; ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <?php echo display('payable_amount'); ?>
                                        </td>
                                        <td class="font-weight text-orange" id="pay-amount">
                                            0
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <?php echo display('cng_amount'); ?>
                                        </td>
                                        <td id="change-amount">
                            ...
                            <div class="grid-container payment-method-calculator">
                            ...
                            <div class="form-group text-right mt-3">
                                <div class="col-sm-12 mt-15 pr-0">
                                    <?php if ($ismerge == 1) {
                                        if ($duemerge == 0) {
                                    ?>
                                    <button type="button" id="duembill" class="btn btn-green w-md m-b-5 m-r-5 col-sm-5"
                                        onclick="duemargebill()"><?php echo display('due_marge'); ?></button>
                                    <?php } ?>
                                    <button type="button" id="paidbill" class="btn btn-green w-md m-b-5 
                                        <?php if ($duemerge == 1) {
                                            echo "col-sm-12";
                                        } else {
                                            echo "col-sm-6";
                                    ...
                                    <?php } else {
                                    ?>
                                    <button type="button" class="btn btn-green w-md m-b-5 sdfgfs" id="pay_bill"
