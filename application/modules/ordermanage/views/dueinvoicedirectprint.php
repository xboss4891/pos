...
if ($storeinfo->isvatnumshow == 1) {?>
        <h5 class="item-title"><?php echo display('tinvat'); ?>: <?php echo $storeinfo->vattinno; ?></h5>
        <?php }
...
?>
    ...
    <div class="invoice_address">
      <div class="row-data">
        ...
        <h5 class="my-0"><?php echo display('bill_by'); ?>: <?php echo @$cashierinfo->firstname . ' ' . @$cashierinfo->lastname; ?></h5>
      </div>
