        ...
        <div class="invoice-card">
                ...
                <div class="row-data">
                    <div class="item-info">
                        <h5 class="item-title"><?php echo display('date'); ?>:
                            <?php echo date("M d, Y", strtotime($billdate)); ?></h5>
                    </div>
                    <?php if ($storeinfo->isvatnumshow == 1) { ?><h5 class="item-title">
                        <?php echo display('tinvat'); ?>:
                        <?php echo $storeinfo->vattinno; ?></h5><?php } ?>
                </div>
            </div>
                    ...
                    <div class="invoice-data">
                        ...
                        foreach ($iteminfo as $item) {
                            ...
                            if (!empty($item->add_on_id)) {
                                ...
                                foreach ($addons as $addonsid) {
                                    ...
                                    $adonsprice = $adonsprice + (float)$adonsinfo->price * (int)$addonsqty[$x];
                                    $x++;
                                }
                                $nittotal = $adonsprice;
                                $itemprice = $itemprice;
                        ...
                        <?php
                            if (!empty($item->add_on_id)) {
                                ...
                                foreach ($addons as $addonsid) {
                                    $adonsinfo = $this->order_model->read('*', 'add_ons', array('add_on_id' => $addonsid));
                                    $adonsprice = $adonsprice + $adonsinfo->price * (int)$addonsqty[$y]; ?>
                        <div class="row-data">
                            <div class="item-info">
                                <h5 class="item-title">-<?php echo $adonsinfo->add_on_name; ?></h5>
                                <p class="item-number"><?php echo $adonsinfo->price; ?> x <?php echo $addonsqty[$y]; ?>
                                </p>
                            </div>
                            <h5><?php if ($currency->position == 1) {
                                                echo $currency->curr_icon;
                                            } ?>
                                <?php echo $adonsinfo->price * (int)$addonsqty[$y]; ?>
                                <?php if ($currency->position == 2) {
                                                echo $currency->curr_icon;
                                            } ?></h5>
                        </div>
            ...
            <div class="invoice-footer mb-15">
                <div class="row-data">
                    ...
                    <h5 class="my-5"><?php if ($currency->position == 1) {
                                            echo $currency->curr_icon;
                                        } ?>
                        <?php echo $allsubtotal; ?> <?php if ($currency->position == 2) {
                                                        echo $currency->curr_icon;
                                                    } ?></h5>
                </div>
                ...
                <div class="row-data">
                    ...
                    <h5 class="my-5"><?php if ($currency->position == 1) {
                        ...
                        <?php echo $calvat; ?> <?php if ($currency->position == 2) {
                                                        echo $currency->curr_icon;
                                                    } ?></h5>
                </div>
                <?php } else {
                ...
                <div class="row-data">
                    <div class="item-info">
                        <h5 class="item-title"><?php echo display('tax_name') ?></h5>
                    </div>
                    <h5 class="my-5"><?php if ($currency->position == 1) {
                                                        echo $currency->curr_icon;
                                                    } ?>
                        <?php echo number_format($multiplletax['tax' . $i]); ?>
                        <?php if ($currency->position == 2) {
                                        echo $currency->curr_icon;
                                    } ?></h5>
                </div>
                ...
                <div class="row-data">
                    ...
                    <h5 class="my-5">
                        <?php if ($currency->position == 1) {
                            echo $currency->curr_icon;
                        } ?><?php echo $servicecharge; ?><?php if ($currency->position == 2) {
                                                                                                                        echo $currency->curr_icon;
                                                                                                                    } ?>
                    </h5>
                </div>
                <div class="row-data">
                    ...
                    <h5 class="my-5"><?php if ($currency->position == 1) {
                        ...
                        <?php echo $discount; ?> <?php if ($currency->position == 2) {
                                                    echo $currency->curr_icon;
                                                } ?></h5>
                </div>
                ...
                <div class="row-data border-top">
                    ...
                    <h5 class="my-5"><?php if ($currency->position == 1) {
                        ...
                        <?php echo $grandtotal; ?> <?php if ($currency->position == 2) {
                                                        echo $currency->curr_icon;
                                                    } ?></h5>
                </div>
                <?php
                if (isset($orderinfo->customerpaid) && $orderinfo->customerpaid > 0) {
                    $customepaid = $orderinfo->customerpaid;
                    $changes = $customepaid - $orderinfo->totalamount;
                } else {
                    $customepaid = $orderinfo->totalamount ?? 0;
                    $changes = 0;
                }
                ?>
                <div class="row-data">
            ...
            <div class="invoice_address">
                <div class="row-data">
                    ...
                    <h5 class="my-5"><?php echo display('bill_by');?>:
                        <?php echo @$cashierinfo->firstname.' '.@$cashierinfo->lastname;?></h5>
                </div>
                ...
                <div class="middle-data">
                    <div class="text-center">
                        <h5 class="item-title" style="font-size:18px; font-weight:bold;">
                            <?php echo display('payment_status'); ?>: <?php
                                                                        if (isset($billinfo->bill_status) && $billinfo->bill_status == 1) {
                                                                            echo 'Paid';
                                                                        } else {
                                                                            if (isset($orderinfo->order_status) && $orderinfo->order_status == 5) {
                                                                                echo 'Canceled';
                                                                            } else {
                                                                                echo display('due');
                                                                            }
