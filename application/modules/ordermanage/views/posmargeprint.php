                    ...
                    <div class="invoice-data">
                        ...
                        ?>
                            ...
                            if (!empty($item->add_on_id)) {
                                ...
                                foreach ($addons as $addonsid) {
                                    $adonsinfo = $this->order_model->read('*', 'add_ons', array('add_on_id' => $addonsid));
                                    $adonsprice = $adonsprice + (float)$adonsinfo->price * (int)$addonsqty[$y]; ?>
                                    <div class="row-data">
                                        <div class="item-info">
            ...
            <div class="invoice-footer mb-15">
                ...
                <div class="row-data">
                    ...
                    <h5 class="my-5"><?php
                                        ...
                                        $multiplepaid = $this->db->select('SUM(amount) as totalpaid')->from('multipay_bill')->where('multipayid', $margeid)->get()->row();
                                        $changes = $multiplepaid->totalpaid - $grandtotal;
