                        ...
                        <?php if (!empty($paymentlist)) { ?>
                            ...
                            <?php foreach ($paymentlist as $payment) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td><?php if($payment->is_active==1){echo display('active');}else{echo display('inactive');} ?></td>
                                   <td class="center">
                                    ...
                                    <input name="url" type="hidden" id="url_<?php echo $payment->payment_method_id; ?>" value="<?php echo base_url("setting/paymentmethod/updateintfrm") ?>" />
                                        <a onclick="editinfo('<?php echo $payment->payment_method_id; ?>')" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="<?php echo display('update')?>"><i class="fa fa-pencil" aria-hidden="true"></i></a> 
                                         <?php endif; 
										 ?>
