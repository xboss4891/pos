...
echo display('payroll') . "&nbsp";
echo display('commission') . "&nbsp";
...
echo $commission->rate . '%';
        ?>
                            ...
                            <td class="center">
                                        ...
                                        <a onclick="showcom('<?php echo $commission->id; ?>')" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="<?php echo display('update') ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>

                                        <a href="<?php echo base_url("setting/Commissionsetting/delete/$commission->id") ?>" onclick="return confirm('<?php echo display("are_you_sure") ?>')" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="right" title="<?php echo display('delete') ?> "><i class="fa fa-trash-o" aria-hidden="true"></i></a>
