            ...
            <div class="panel-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="total_salary" class="form-control"
                            placeholder="<?php echo display('total_salary') ?>" id="total_salary">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="total_working_minutes"
                            placeholder="<?php echo display('total_working_minutes') ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <select name="payment_due" class="form-control" id="payment_due">
                            ...
                            <option value="<?php echo display('paid'); ?>">Paid</option>
                            <option value="<?php echo display('unpaid'); ?>"><?php echo display('unpaid'); ?></option>
                        </select>
                ...
                <div class="form-group row">
                    <label for="payment_date" class="col-sm-3 col-form-label"><?php echo display('payment_date') ?>
                        *</label>
                    <div class="col-sm-9">
                        <input type="text" name="payment_date" class="datepicker form-control"
                            placeholder="<?php echo display('payment_date') ?>" id="payment_date">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="paid_by" class="form-control"
                            placeholder="<?php echo display('paid_by') ?>" id="paid_by">
                    </div>
                </div>
