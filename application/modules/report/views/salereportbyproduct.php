<script src="<?php echo base_url('application/modules/report/assets/js/salereportbyproduct.js'); ?>" type="text/javascript"></script>
<link href="<?php echo base_url('application/modules/report/assets/css/salereportbyproduct.css'); ?>" rel="stylesheet" type="text/css"/>
