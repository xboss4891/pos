...
<script src="<?php echo base_url('application/modules/report/assets/js/salebytable.js'); ?>" type="text/javascript"></script>
<link href="<?php echo base_url('application/modules/report/assets/css/salebytable.css'); ?>" rel="stylesheet" type="text/css"/>
