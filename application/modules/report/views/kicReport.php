...
<script src="<?php echo base_url('application/modules/report/assets/js/kicReport.js'); ?>" type="text/javascript"></script>
<link href="<?php echo base_url('application/modules/report/assets/css/kicReport.css'); ?>" rel="stylesheet" type="text/css"/>
		        ...
		        <div class="panel panel-bd lobidrag">
		            <div class="panel-heading">
		                <div class="panel-title">
		                    <h4><?php echo display('kitchenitemsell') ?></h4>
		                </div>
		            </div>
		            <div class="panel-body">
		            	<div id="purchase_div">
