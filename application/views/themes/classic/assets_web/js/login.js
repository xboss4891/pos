...
function logincustomer() {
  ...
  if (email == "") {
    errormessage =
      errormessage + "<span>" + lang.please_enter_your_email + "</span>";
...
function lostpassword() {
  ...
  if (email == "") {
    errormessage =
      errormessage + "<span>" + lang.enter_your_phone_or_email + "</span>";
    alert(lang.please_enter_your_email);
    return false;
  }
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      if (err == "404") {
        ...
        alert(
          lang.have_been_sent_email +
            " " +
            email +
            " " +
            lang.check_your_new_password
        );
