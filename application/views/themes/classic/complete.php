...
<link href="<?php echo base_url('themes/'.$acthemename.'/assets_web/css/complete.css') ?>" rel="stylesheet"
    type="text/css" />
<!--Start Menu Area-->
    ...
    <div class="container wow fadeIn">
        ...
        <div class="row">
            <div class="col-xl-3 col-md-4 sidebar leftSidebar">
                <form class="form-inline mb-3" action="<?php echo base_url() . 'menu'; ?>" method="post">
                    <input type="text" class="form-control productSelection" onkeypress="producstList();"
                        name="product_name" id="product_name" placeholder="<?php echo display('search') ?>"
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h6 class="panel-title">
                                    <a href="#<?php echo $hcategoryname; ?>" class="accordion-toggle"
                                        data-toggle="collapse" aria-expanded="false"><?php echo $category->Name; ?></a>
                                </h6>
                            </div>
                            <div id="<?php echo $hcategoryname; ?>" class="panel-collapse collapse <?php if ($op == 1) {
                                ...
                                <div class="panel-body">
                                    <a onclick="searchmenu('<?php echo $category->CategoryID; ?>')"
                                        style="cursor:pointer;"><i
                                            class="ti-minus mr-2"></i><?php echo $category->Name; ?><span>(<?php echo $ProdcutQTY; ?>)</span></a>
                                    <?php foreach ($category->sub as $subcat) {
                                            ...
                                            ?>
                                    <a onclick="searchmenu('<?php echo $subcat->CategoryID; ?>')" class="serach"><i
                                            class="ti-minus mr-2"></i><?php echo $subcat->Name; ?><span>(<?php echo $ProdcutQTYsub; ?>)</span></a>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-xl-6 col-md-8 mainContent">
                <div id="loaditem">
                    <div id="loadingcon" class="completecss"><img
                            src="<?php echo base_url(); ?>/view/themes/<?php echo $acthemename; ?>/assets_web/images/loader.gif"
                            alt="loader" width="180" /></div>
                    ...
                    <ul class="list-unstyled grid-container">
                        ...
                        <li class="single_item">
                            ...
                            <div class="row mb-3">
                                <div class="item_img">
                                    <img src="<?php echo base_url(!empty($menuitem->medium_thumb) ? $menuitem->medium_thumb : 'assets/img/no-image.png'); ?>"
                                        class="img-fluid" alt="<?php echo $menuitem->ProductName ?>">
                                </div>
                                <div class="item_details">
                                    <a href="<?php echo base_url() . 'details/' . $menuitem->ProductsID . '/' . $menuitem->variantid; ?>"
                                        class="item_title"><?php echo $menuitem->ProductName ?></a>
                                    <div class="grid_only">
                                    ...
                                    <?php if (!empty($menuitem->descrip)) { ?><p>
                                        (<?php echo substr($menuitem->descrip, 0, 50); ?>)</p><?php } ?>
                                    <?php if ($addtocart == 1) {
                                                    if($getadons == 0 && $menuitem->totalvarient==1) { ?>
                                    <div class="d-flex align-items-center mt-2">
                                        <input name="sizeid" type="hidden" id="sizeid_<?php echo $id; ?>other"
                                            value="<?php echo $menuitem->variantid; ?>" />
                                        <input type="hidden" name="catid" id="catid_<?php echo $id; ?>other"
                                            value="<?php echo $menuitem->CategoryID; ?>">
                                        <input type="hidden" name="itemname" id="itemname_<?php echo $id; ?>other"
                                            value="<?php echo $menuitem->ProductName; ?>">
                                        <input type="hidden" name="varient" id="varient_<?php echo $id; ?>other"
                                            value="<?php echo $menuitem->variantName; ?>">
                                        <input type="hidden" name="cartpage" id="cartpage_<?php echo $id; ?>other"
                                            value="0">
                                        <input name="itemprice" type="hidden" value="<?php echo $menuitem->price; ?>"
                                            id="itemprice_<?php echo $id; ?>other" />

                                        <a onclick="addtocartitem(<?php echo $menuitem->ProductsID; ?>,<?php echo $id; ?>,'other')"
                                            class="simple_btn mt-0 mr-2 text-white"><?php echo display('add_to_cart')?></a>
                                        <div class="cart_counter">
                                            <button
                                                onclick="var result = document.getElementById('sst6<?php echo $id; ?>_other'); var sst = result.value; if( !isNaN( sst ) &amp;&amp; sst > 0 ) result.value--;return false;"
                                                class="reduced items-count" type="button">
                                                <i class="fa fa-minus"></i>
                                            </button>
                                            <input type="text" name="qty" id="sst6<?php echo $id; ?>_other"
                                                maxlength="12" value="1" title="Quantity:" class="input-text qty">
                                            <button
                                                onclick="var result = document.getElementById('sst6<?php echo $id; ?>_other'); var sst = result.value; if( !isNaN( sst )) result.value++;return false;"
                                    ...
                                    <?php } else { ?>
                                    <div class="d-flex align-items-center mt-2">
                                        <a onclick="addonsitem(<?php echo $menuitem->ProductsID; ?>,<?php echo $menuitem->variantid; ?>,'other')"
                                            class="simple_btn mt-0 mr-2 text-white" data-toggle="modal"
                                            data-target="#addons"
                                            data-dismiss="modal"><?php echo display('add_to_cart')?></a>
                                        <div class="cart_counter">
                                            <button
                                                onclick="var result = document.getElementById('sst6<?php echo $id; ?>_other'); var sst = result.value; if( !isNaN( sst ) &amp;&amp; sst >= 1 ) result.value--;return false;"
                                                class="reduced items-count" type="button">
                                                <i class="fa fa-minus"></i>
                                            </button>
                                            <input type="text" name="qty" id="sst6<?php echo $id; ?>_other"
                                    ...
                                    <div class="grid_only">
                                        <h6 class="mb-0">
                                            <?php if ($addtocart == 0) { echo display('not_available'); } ?></h6>
                                    </div>
                                </div>
                        ...
                        <li class="single_item">
                            <div class="row mb-3">
                                <a href="<?php echo base_url() . 'menu'; ?>"
                                    class="item_title"><?php echo display('no_data_found') ?></a>
                            </div>
                        </li>
                        <?php } ?>
                    ...
                    <li class="cart-content row">
                        <div class="img-box">
                            <img src="<?php echo base_url(!empty($iteminfo->small_thumb) ? $iteminfo->small_thumb : 'assets/img/no-image.png'); ?>"
                                class="img-fluid" alt="<?php echo $item['name']; ?>">
                        </div>
                        <div class="content">
                    ...
                    <li class="cart-footer text-right">
                        <div class="checkout-box">
                            <a href="<?php echo base_url(); ?>cart"
                                class="simple_btn mt-0"><?php echo display('go_to_checkout') ?></a>
                        </div>
                    </li>
                    <?php }
                        ?>
...
swal({
    ...
    function(isConfirm) {
        if (isConfirm) {
            window.open(
                "https://api.whatsapp.com/send?phone=<?php echo $wtapp->whatsapp_number;?>&text=<?php echo $html;?>",
                "_blank");
