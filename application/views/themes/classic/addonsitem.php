...
<div class="item-add-ons">
                        ...
                        <div class="d-flex align-items-center justify-content-between ml-6">
                            <select name="varientinfo" class="form-control" style="width:120px;" required id="varientinfo">
 ...
 <div class="item-add-ons" style="border-bottom: 1px solid #e9ecef;margin: 15px 0;">
...
?>
<a class="btn btn-success" onclick="addonsfoodtocart(<?php echo $item->ProductsID;?>,1,'<?php echo $flag;?>')"><?php echo display('add_to_cart')?></a>
<a class="btn btn-success" onclick="addonsfoodtocartmulti(<?php echo $item->ProductsID;?>,1,'<?php echo $flag;?>')"><?php echo display('add_to_cart_more')?></a>
</div>
