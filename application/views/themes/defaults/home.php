<div class="modal fade" id="closenotice" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p><?php echo display('closed_msg'); ?> <?php echo $this->settinginfo->opentime; ?>-
                    <?php echo $this->settinginfo->closetime; ?></p>
            </div>
            ...
            <div class="form-row">
                <div class="col-md-6 mb-3 mb-md-0">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control productSelection" onkeypress="producstList();"
                            name="product_name" id="product_name" placeholder="<?php echo display('search_food_item')?>"
                            aria-required="true"> <input class="autocomplete_hidden_value" name="product_id"
                ...
                <div class="col-md-4 mb-3 mb-md-0">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control categorySelection" onkeypress="allcategoryList();"
                            name="category_name" id="category_name"
                            placeholder="<?php echo display('search_category')?>"><input
                            class="autocomplete_hidden_value2" name="category_id" id="SchoolHiddenId2" type="hidden">
                    </div>
                </div>
                <div class="col-md-2">
        ...
        <div class="row about_inner">
            <div class="col-lg-5 col-xl-6 text-center wow fadeIn">
                ...
                <div class="aboutus_text mb-lg-0 mb-5">
                    ...
                    <a href="<?php echo $banner_story[0]->slink; ?>"
                        class="simple_btn"><?php echo display('read_more')?></a>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                        <div class="img_part mb-4 mb-sm-0 wow fadeIn" data-wow-delay="0.4s">
                            <img src="<?php echo base_url(!empty($story->image) ? $story->image : 'dummyimage/263x332.jpg'); ?>"
                                class="img-fluid" alt="<?php echo $story->title ?>">
                        </div>
                    </div>
                    <?php } ?>
    ...
    <div class="container">
        ...
        <div class="row offer_inner wow fadeIn" data-wow-delay="0.5s">
            <div class="offer_slider owl-carousel">
                ...
                <div class="item">
                    <div class="img_area">
                        <img src="<?php echo base_url(!empty($best->medium_thumb) ? $best->medium_thumb : 'dummyimage/268x223.jpg'); ?>"
                            alt="<?php echo $best->ProductName ?>">
                    </div>
                    <div class="item_content text-center pb-4">
                        <?php if ($best->OffersRate > 0) { ?>
                        <span class="top_side">-<?php echo $best->OffersRate; ?>%</span>
                        <?php } ?>
                        <a href="<?php echo base_url() . 'details/' . $best->ProductsID . '/' . $best->variantid; ?>"
                            class="item_name"><?php echo $best->ProductName ?></a>
                        <p><?php if ($this->storecurrency->position == 1) {echo $this->storecurrency->curr_icon;} ?><?php echo $best->price; ?><?php if ($this->storecurrency->position == 2) {echo $this->storecurrency->curr_icon;} ?>
                        </p>
                        <?php if ($restaurantisopen == 1) {
                                    if ($addtocart == 1) {
                                        if($getadons == 0 && $best->totalvarient==1) { ?>
                        <input type="hidden" name="qty" id="sst6<?php echo $id; ?>_other" value="1">
                        <input name="sizeid" type="hidden" id="sizeid_<?php echo $id; ?>other"
                            value="<?php echo $best->variantid; ?>" />
                        <input type="hidden" name="catid" id="catid_<?php echo $id; ?>other"
                            value="<?php echo $best->CategoryID; ?>">
                        <input type="hidden" name="itemname" id="itemname_<?php echo $id; ?>other"
                            value="<?php echo $best->ProductName; ?>">
                        <input type="hidden" name="varient" id="varient_<?php echo $id; ?>other"
                            value="<?php echo $best->variantName; ?>">
                        <input type="hidden" name="cartpage" id="cartpage_<?php echo $id; ?>other" value="0">
                        <input name="itemprice" type="hidden" value="<?php echo $best->price; ?>"
                            id="itemprice_<?php echo $id; ?>other" />
                        <div id="snackbar<?php echo $id; ?>" class="snackbar">
                            <?php echo display('item_has_been_successfully_added')?></div>
                        <a onclick="addtocartitem(<?php echo $best->ProductsID; ?>,<?php echo $id; ?>,'other')"
                            class="simple_btn"> <i
                                class="ti-shopping-cart mr-2"></i><span><?php echo display('add_to_cart')?></span></a>
                        <?php } else { ?>
                        <div id="snackbar<?php echo $id; ?>" class="snackbar">
                            <?php echo display('item_has_been_successfully_added')?></div>
                        <a onclick="addonsitem(<?php echo $best->ProductsID; ?>,<?php echo $best->variantid; ?>,'other')"
                            class="simple_btn" data-toggle="modal" data-target="#addons" data-dismiss="modal"> <i
                                class="ti-shopping-cart mr-2"></i><span><?php echo display('add_to_cart')?></span></a>
                        <?php }
                                    } else {
                                        echo $availavail;
                        ...
                        <a class="simple_btn" data-toggle="modal" data-target="#closenotice" data-dismiss="modal"> <i
                                class="ti-shopping-cart mr-2"></i><span><?php echo display('add_to_cart')?></span></a>
                        <?php }
                                ?>
                    </div>
        ...
        <div class="row about_inner">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="img_part mb-4 mb-md-0">
                            <a href="<?php echo $bimage->slink; ?>"><img
                                    src="<?php echo base_url(!empty($bimage->image) ? $bimage->image : 'dummyimage/263x374.jpg'); ?>"
                                    class="img-fluid" alt="<?php echo $bimage->title; ?>"></a>
                        </div>
                    </div>
                    <?php } else {
            ...
            <div class="col-xl-6 col-lg-5 text-center pl-lg-5 px-3 wow fadeIn" data-wow-delay="0.5s">
                ...
                <div class="aboutus_text">
                    ...
                    <a href="<?php echo $banner_menu[0]->slink; ?>"
                        class="simple_btn"><?php echo display('view_full_menu')?></a>
                </div>
                <?php } ?>
            </div>
        </div>
            ...
            <div class="col-lg-12 text-center">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                        ...
                        <input type="number" name="reservation_person" id="reservation_person"
                            placeholder="Total Person" autocomplete="off">
                    </div>
                    <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                        <label for="reservation_date"><i class="ti-calendar"></i></label>
                        <input type="text" name="reservation_date" id="reservation_date" placeholder="Expected Date"
                            class="datepickerreserve" autocomplete="off">
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <button type="button" class="simple_btn"
                            onclick="checkavailablity()"><?php echo display('check_availablity')?></button>
                    </div>
                </div>
                </form>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 wow fadeIn">
                <div class="menu_slider owl-carousel">
                    ...
                    <div class="menu_item">
                        <div class="menu_info">
                            <a href="<?php echo base_url() . 'details/' . $special->ProductsID . '/' . $special->variantid; ?>"
                                class="h1 d-block mb-3"><?php echo $special->ProductName ?></a>
                            <p><?php echo $special->descrip ?></p>
                            <h2><?php if ($this->storecurrency->position == 1) {
                                            echo $this->storecurrency->curr_icon;
                                        } ?><?php echo $special->price; ?><?php if ($this->storecurrency->position == 2) {echo $this->storecurrency->curr_icon;} ?>
                            </h2>
                            <a href="#" class="simple_btn"><i
                                    class="ti-shopping-cart"></i><span><?php echo display('add_to_cart')?></span></a>
                        </div>
                        <div class="menu_img">
                            <img src="<?php echo base_url(!empty($special->small_thumb) ? $special->small_thumb : 'dummyimage/253x263.jpg'); ?>"
                                alt="<?php echo $special->ProductName ?>">
                        </div>
                    </div>
                    <?php } ?>
            ...
            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 team_slider owl-carousel">
                ...
                <div class="single-team-member text-center">
                    <div class="team-member-img ">
                        <img src="<?php echo base_url(!empty($team->picture) ? $team->picture : 'dummyimage/363x363.jpg'); ?>"
                            alt="">
                    </div>
