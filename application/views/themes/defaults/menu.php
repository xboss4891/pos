...
foreach ($categorylist as $category) {
    ...
    ?>
                            <div class="panel panel-default">
                                ...
                                <?php
?>
                                <div id="<?php echo $hcategoryname; ?>" class="panel-collapse collapse <?php
        ...
        if ($restaurantisopen == 1) {
            ...
            if ($addtocart == 1) {
                ...
                if ($getadons == 0 && $menuitem->totalvarient == 1) {?>
											...
											<?php } else {?>
                                               <div id="snackbar<?php echo $id; ?>" class="snackbar"><?php echo display('item_has_been_successfully_added') ?></div>
                                                <a onclick="addonsitem(<?php echo $menuitem->ProductsID; ?>,<?php echo $menuitem->variantid; ?>,'menu')" class="simple_btn mt-1" data-toggle="modal" data-target="#addons" data-dismiss="modal"><?php echo display('add_to_cart') ?></a>
                                        <?php }
...
// Ensure $multiplletax[$fildname] is initialized
...
/*check $taxsetting info*/
    ...
    ?><?php echo $itemtotal; ?><?php if ($this->storecurrency->position == 2) {echo $this->storecurrency->curr_icon;}
    ...
    ?><?php echo $calvat; ?><?php if ($this->storecurrency->position == 2) {echo $this->storecurrency->curr_icon;}
    ...
    ?><?php echo $discount; ?><?php if ($this->storecurrency->position == 2) {echo $this->storecurrency->curr_icon;}
