                    ...
                    <div class="bg-light border cart-totals p-4">
                        ...
                        <div class="cart-totals-border my-4">
                            ...
                            <div class="totals-item totals-item-total">
                                ...
                                <div class="totals-value" id="gtotal"><?php if($this->storecurrency->position==1){echo $this->storecurrency->curr_icon;}?><span id="grtotal"><?php $isvatinclusive=$this->db->select("*")->from('setting')->get()->row();
									if($isvatinclusive->isvatinclusive==1){
										echo ($itemtotal)-($discount+$coupon);
									}else{
										echo ($calvat+$itemtotal)-($discount+$coupon);
									}
