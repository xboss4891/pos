            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="product_img">
                        <img src="<?php echo base_url(!empty($iteminfo->bigthumb) ? $iteminfo->bigthumb : 'dummyimage/555x370.jpg'); ?>"
                            class="img-fluid" alt="<?php echo $iteminfo->ProductName; ?>">
                    </div>
                ...
                <div class="col-md-6">
                    <div class="product-summary-content">
                        <div class="product-summary">
                            <div class="product-price row m-0">
                                ...
                                echo $this->storecurrency->curr_icon;
                                        ...
                                        id="vpricedt"><?php echo $iteminfo->price;?></span><?php if ($this->storecurrency->position == 2) { echo $this->storecurrency->curr_icon; } ?>
                                </h1>

                            </div>
                        </div>
                        <p><span class="mr-2"><?php echo display('size')?>:</span> <select name="varientinfo"
                                class="form-control details_w_50" required id="varientinfodt">
                                ...
                                <option value="<?php echo $thisvarient->variantid;?>"
                                    ...
                                    <?php if($item->variantid==$thisvarient->variantid){ echo "selected";}?>>
                        ...
                        <div class="cart_counter">
                            ...
                            <input type="number" name="qty" id="sst6999_det" min="1" maxlength="12" value="1"
                                title="<?php echo display('quantity')?>:" class="input-text qty">
                            ...
                            <input name="sizeid" type="hidden" id="sizeid_999det"
                                value="<?php echo $iteminfo->variantid; ?>" />
                            <input type="hidden" name="catid" id="catid_999det"
                                value="<?php echo $iteminfo->CategoryID; ?>">
                            <input type="hidden" name="itemname" id="itemname_999det"
                                value="<?php echo $iteminfo->ProductName; ?>">
                            <input type="hidden" name="varient" id="varient_999det"
                                value="<?php echo $iteminfo->variantName; ?>">
                            <input type="hidden" name="cartpage" id="cartpage_999det" value="0">
                            <input name="itemprice" type="hidden" value="<?php echo $iteminfo->price; ?>"
                                id="itemprice_999det" />
                    ...
                    if($getadons == 0) { ?>
                        ...
                        <a onclick="addtocartitem(<?php echo $iteminfo->ProductsID; ?>,999,'det')"
                            class="simple_btn mt-3" id="chng_<?php echo $iteminfo->ProductsID; ?>">
                        ...
                        <a onclick="addonsitem(<?php echo $iteminfo->ProductsID; ?>,<?php echo $iteminfo->variantid; ?>,'other')"
                            id="chng_<?php echo $iteminfo->ProductsID; ?>" class="simple_btn mt-3" data-toggle="modal"
                            data-target="#addons" data-dismiss="modal">
                            <i class="ti-shopping-cart mr-2"></i><span><?php echo display('add_to_cart')?></span></span>
                        </a>
                    ...
                    ?>
                        <a class="simple_btn mt-3" data-toggle="modal" data-target="#closenotice" data-dismiss="modal">
                            <i class="ti-shopping-cart mr-2"></i><span>add to cart</span></a>
                        <?php } ?>
                                ...
                                <div class="rating-block text-center">
                                    ...
                                    <div class="rating-point center-block">
                                        ...
                                        <h4 class="rating-count">
                                            <?php echo number_format($average->averagerating ?? 0, 1); ?></h4>
                                    </div>
                                    <div><?php echo $totalrating->totalrate; ?> <?php echo display('rating')?> &amp;
                                    </div>
                                ...
                                <div class="rating-position">
                                    ...
                                    <div class="rating-dimension">
                                        ...
                                        <div class="rating-percent">
                                            <div class="progress">
                                                <div class="progress-bar progress-bar-success details_w_100"
                                    ...
                                    <div class="rating-dimension">
                                        ...
                                        <div class="rating-percent">
                                            <div class="progress">
                                                <div class="progress-bar progress-bar-primary details_w_80"
                                                    role="progressbar" aria-valuenow="5" aria-valuemin="0"
                                                    aria-valuemax="5">
                                                    <span
                                    ...
                                    <div class="rating-dimension">
                                        ...
                                        <div class="rating-percent">
                                            <div class="progress">
                                                <div class="progress-bar progress-bar-info details_w_60"
                                                    role="progressbar" aria-valuenow="5" aria-valuemin="0"
                                                    aria-valuemax="5">
                                                    <span
                                    ...
                                    <div class="rating-dimension">
                                        ...
                                        <div class="rating-percent">
                                            <div class="progress">
                                                <div class="progress-bar progress-bar-warning details_w_40"
                                                    role="progressbar" aria-valuenow="5" aria-valuemin="0"
                                                    aria-valuemax="5">
                                                    <span
                                    ...
                                    <div class="rating-dimension">
                                        ...
                                        <div class="rating-percent">
                                            <div class="progress">
                                                <div class="progress-bar progress-bar-danger details_w_20"
                                                    role="progressbar" aria-valuenow="5" aria-valuemin="0"
                                                    aria-valuemax="5">
                                                    <span
                            ...
                            <div class="review-block">
                                <div class="row m-0 review-block-rate">
                                    <button type="button" class="btn btn-success btn-sm mb-2"
                                        aria-label="Left Align"><?php echo $x = round($myreview->rating / 5) * 5; ?> <i
                                            class="ti-star" aria-hidden="true"></i></button>
                                ...
                                <div class="review-meta-row">
                                    <div class="review-meta-inner">
                                        ...
                                        <span class="review-block-date">
                                            <?php echo $newDate = date("F ,d, Y", strtotime($myreview->ratetime)); ?>
    ...
    <div class="container">
        ...
        <div class="row offer_inner">
            <div class="offer_slider owl-carousel">
                ...
                <div class="item">
                    <div class="img_area">
                        <img src="<?php echo base_url(!empty($relateditem->medium_thumb) ? $relateditem->medium_thumb : 'dummyimage/268x223.jpg'); ?>"
                            alt="<?php echo $relateditem->ProductName ?>">
                    </div>
                    <div class="item_content text-center pb-4">
                        ...
                        <?php } ?>
                        <a href="<?php echo base_url() . 'details/' . $relateditem->ProductsID . '/' . $relateditem->variantid; ?>"
                            class="item_name"><?php echo $relateditem->ProductName ?></a>
                        ...
                        <div id="snackbar<?php echo $id; ?>" class="snackbar">
                            <?php echo display('item_has_been_successfully_added')?></div>
                        <a onclick="addtocartitem(<?php echo $relateditem->ProductsID; ?>,<?php echo $id; ?>,'rel')"
                            class="simple_btn">
                        ...
                        <div id="snackbar<?php echo $id; ?>" class="snackbar">
                            <?php echo display('item_has_been_successfully_added')?></div>
                        <a onclick="addonsitem(<?php echo $relateditem->ProductsID; ?>,<?php echo $relateditem->variantid; ?>,'other')"
                            class="simple_btn" data-toggle="modal" data-target="#addons" data-dismiss="modal">
                            <i class="ti-shopping-cart mr-2"></i><span><?php echo display('add_to_cart')?></span>
                        </a>
                        <?php }
                                        } else {
...
<script type="text/javascript"
    src="<?php echo base_url(); ?>application/views/themes/<?php echo $this->themeinfo->themename; ?>/assets_web/js/jquery.rateyo.js">
</script>
<script
    src="<?php echo base_url(); ?>application/views/themes/<?php echo $this->themeinfo->themename; ?>/assets_web/js/details.js">
</script>