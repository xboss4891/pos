       ...
       <div class="modal-dialog" role="document">
           <div class="modal-content modal-addons">
               ...
               <div class="modal-body">
                   ...
                   <div class="col-sm-4">
                       <a onclick="addnotetoitem()"
                           class="checkout btn btn-md text-white"><?php echo display('addnotesi') ?></a>
                   </div>
                   ...
                   <div class="table-responsive">
                       ...
                       <?php
                        ...
                        ?>
                           ...
                           <table class="table table-bordered text-center mb-0" <?php
                               ...
                               <tbody>
                                   <?php $i = 0;
                                    ...
                                    ?>
                                       <tr>
                                           <td class="cart_image"><img
                                                   src="<?php echo base_url(!empty($iteminfo->small_thumb) ? $iteminfo->small_thumb : 'assets/img/no-image.png'); ?>"
                                                   class="img-fluid" alt="<?php echo $item['name']; ?>"></td>
                                           ...
                                           <td>
                                               <div class="cart_counter">
                                                   ...
                                                   <input type="text" name="qty" id="sst3" maxlength="12"
                                                       value="<?php echo $item['qty']; ?>" title="Quantity:"
                                           ...
                                           <td>
                                               <?php if ($this->storecurrency->position == 1) {
                                                ...
                                                ?><?php echo $itemprice - $discal; ?><?php if ($this->storecurrency->position == 2) {
                                                                                            echo $this->storecurrency->curr_icon;
                                                                                        }
                                                                                        ?>
                                           </td>
                           ...
                           <div class="payment-block" id="payment">
                               <?php foreach ($shippinginfo as $shipment) { ?>
                                   <div class="payment-item">
                                       <input type="radio" name="payment_method" id="payment_method_cre"
                                           data-parent="#payment" data-target="#description_cre"
                                       ...
                                       <label for="payment_method_cre"> <?php echo $shipment->shipping_method; ?> - <?php if ($this->storecurrency->position == 1) {
                                                                                                                        echo $this->storecurrency->curr_icon;
                                                                                                                    }
                                                                                                                    ?><?php echo $shipment->shippingrate; ?><?php if ($this->storecurrency->position == 2) {
                                                                                                                                                                echo $this->storecurrency->curr_icon;
                                                                                                                                                            }
                                                                                                                                                            ?></label>
                                   </div>
                           ...
                           <div class="row mx-0">
                               <div class="col-sm-6 px-0">
                                   ...
                                   <input type="text" name="orderdate" id="orderdate"
                                       value="<?php echo date('Y-n-j'); ?>" class="datepickerreserve mr-2 cart_w_96">
                               </div>
                               <div class="col-sm-6 px-0">
                                   <label>Receive Time</label>
                                   <input type="text" name="ordertime" id="reservation_time"
                                       value="<?php echo date('H:i'); ?>" class="cart_w_100">
                               </div>
                           </div>
                       </div>
                           ...
                           <div class="bg-light border cart-totals p-4">
                               ...
                               <div class="cart-totals-border my-4">
                                   <div class="totals-item">
                                       ...
                                       <div class="totals-value" id="cart-subtotal"><?php if ($this->storecurrency->position == 1) {
                                                                                        echo $this->storecurrency->curr_icon;
                                                                                    }
                                                                                    ?><span
                                               id="subtotal"><?php echo $itemtotal; ?></span><?php if ($this->storecurrency->position == 2) {
                                                                                                    echo $this->storecurrency->curr_icon;
                                                                                                }
                                                                                                ?></div>
                                   </div>
                                   <div class="totals-item">
                                       <label>Vat </label>
                                       <div class="totals-value" id="cart-tax"><?php if ($this->storecurrency->position == 1) {
                                                                                    echo $this->storecurrency->curr_icon;
                                                                                }
                                                                                ?><span
                                               id="vat"><?php echo $calvat; ?></span><?php if ($this->storecurrency->position == 2) {
                                                                                            echo $this->storecurrency->curr_icon;
                                                                                        }
                                                                                        ?></div>
                                   </div>
                                   <div class="totals-item">
                                       ...
                                       <div class="totals-value" id="Discount-charge"><?php if ($this->storecurrency->position == 1) {
                                                                                            echo $this->storecurrency->curr_icon;
                                                                                        }
                                                                                        ?><span
                                               id="discount"><?php echo $discount; ?></span><?php if ($this->storecurrency->position == 2) {
                                                                                                echo $this->storecurrency->curr_icon;
                                                                                            }
                                                                                            ?></div>
                                   </div>
                                   <?php $coupon = 0;
                                    if (!empty($this->session->userdata('couponcode'))) { ?>
                                       <div class="totals-item">
                                           ...
                                           <div class="totals-value" id="coupDiscount-charge"><?php if ($this->storecurrency->position == 1) {
                                                                                                    echo $this->storecurrency->curr_icon;
                                                                                                }
                                                                                                ?><span
                                                   id="coupdiscount"><?php echo $coupon = $this->session->userdata('couponprice'); ?></span><?php if ($this->storecurrency->position == 2) {
                                                                                                                                                echo $this->storecurrency->curr_icon;
                                                                                                                                            }
                                                                                                                                            ?></div>
                                       </div>
                                   ...
                                   <div class="totals-item">
                                       ...
                                       <div class="totals-value" id="Service"><?php if ($this->storecurrency->position == 1) {
                                                                                    echo $this->storecurrency->curr_icon;
                                                                                }
                                                                                ?><span
                                               id="scharge"><?php echo "0"; ?></span><?php if ($this->storecurrency->position == 2) {
                                                                                            echo $this->storecurrency->curr_icon;
                                                                                        }
                                                                                        ?> <input name="servicecharge" type="hidden" value="0"
                                               id="getscharge" /><input name="servicename" type="hidden" value=""
                                               id="servicename" /></div>
                                   </div>
                                   <div class="totals-item totals-item-total">
                                       <label>Grand Total</label>
                                       <div class="totals-value" id="gtotal">
                                           <?php
                                            if ($this->storecurrency->position == 1) {
                                                echo $this->storecurrency->curr_icon;
                                            }
                                           ...
                                           <span id="grtotal">
                                               <?php
                                                ...
                                                echo number_format($gtotal, 2); ?></span><?php if ($this->storecurrency->position == 2) {
                                                                            echo $this->storecurrency->curr_icon;
                                                                        }
                                                                        ?>
                                       </div>
