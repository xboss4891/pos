...
<?php echo  form_open('hungry/bookreservation',array('id'=>'reservesubmit')) ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8"><input type="text" name="mobile" class="form-control" id="phone" placeholder="+8801712121212" value="<?php echo (!empty($customerinfo->customer_phone)?$customerinfo->customer_phone:null) ?>" required></div>
                    </div>
                    <div class="form-group row">
