					...
					<?php  $totalqty=0;
                        ...
                        <?php 
							...
							if($isvatinclusive->isvatinclusive==1){
								$grandtotal= $totalamount+$servicecharge-($discount+$coupon);
							}else{
								$grandtotal= $totalamount+$calvat+$servicecharge-($discount+$coupon);
							}
							?>
                        <p><?php if($this->storecurrency->position==1){echo $this->storecurrency->curr_icon;}?><?php echo $grandtotal;?><?php if($this->storecurrency->position==2){echo $this->storecurrency->curr_icon;}?></p>
                        </li>
                    </ul>
